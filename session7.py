...
def function_1_docstring_50_count(fn: "Input function") -> "Returns docstring stored in free variable":
    """
...
def function_2_fibonacci() -> "his Closure function gives the next fibonnaci number":
    fibonnaci_series = [0]
